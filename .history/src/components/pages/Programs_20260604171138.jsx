  ...
  const programs = [
    {
      ...
      features: ["Public Speaking", "Presentation Skills", "Stage Confidence", "Professional Communication", "Interpersonal Skills"],
    },
    {
      ...
      reverse: true,
      features: ["Decision Making", "Team Building", "Problem Solving", "Critical Thinking", "Leadership Activities"],
    },
    {
      ...
      features: ["Confidence Building", "Professional Etiquette", "Growth Mindset", "Self Development", "Personal Branding"],
    },
    {
      ...
      reverse: true,
      features: ["Empathy", "Self Awareness", "Stress Management", "Relationship Building", "Emotional Control"],
    },
    {
      ...
      features: ["Career Readiness", "Interview Skills", "Networking", "Innovation", "Adaptability"],
    },
  ];

  const prev = () => setCurrent((c) => (c - 1 + programs.length) % programs.length);
  const next = () => setCurrent((c) => (c + 1) % programs.length);
  ...
  return (
    <>
      ...
      <div className="program-slider-section">
        ...
        {/* Track */}
        <div className="program-slider-track-wrap">
          <div
            className="program-slider-track"
        ...
        <div className="program-slider-controls">
          <button className="slider-nav-btn" onClick={prev} aria-label="Previous">&#8249;</button>
          ...
          <button className="slider-nav-btn" onClick={next} aria-label="Next">&#8250;</button>
        </div>
